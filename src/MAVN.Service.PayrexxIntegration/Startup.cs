...
namespace MAVN.Service.PayrexxIntegration
{
    ...
    public class Startup
    {
        ...
        {
            ApiTitle = "PayrexxIntegration API",
            ApiVersion = "v1"
        };
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            (_configurationRoot, _settingsManager) = services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "PayrexxIntegrationLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.PayrexxIntegrationService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("PayrexxIntegration", channelOptions =>
                        {
